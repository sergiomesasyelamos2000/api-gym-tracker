...
export class Initial1738829295000 implements MigrationInterface {
  name = 'Initial1738829295000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "routine_session_entity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "exercises" jsonb DEFAULT '[]', "totalTime" integer NOT NULL, "totalWeight" integer NOT NULL, "completedSets" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "routineId" uuid, CONSTRAINT "PK_2c64835e3d3289de03ab20e36d7" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "routine_entity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, "totalTime" integer NOT NULL DEFAULT '0', "userId" uuid NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_5c7025317377578906ed5da6201" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "equipment_entity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "image" text, CONSTRAINT "PK_5671e664ae956c44ed93f466cdc" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "muscle_entity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "image" text, CONSTRAINT "PK_e49334faa57a573b671e586f091" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "exercise_type_entity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "image" text, CONSTRAINT "PK_499935be92d94442743623e4d7c" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."food_entries_mealtype_enum" AS ENUM('breakfast', 'lunch', 'dinner', 'snack')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."food_entries_unit_enum" AS ENUM('gram', 'ml', 'portion', 'custom')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."shopping_list_items_unit_enum" AS ENUM('gram', 'ml', 'portion', 'custom')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."user_nutrition_profiles_gender_enum" AS ENUM('male', 'female', 'other')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."user_nutrition_profiles_activitylevel_enum" AS ENUM('sedentary', 'lightly_active', 'moderately_active', 'very_active', 'extra_active')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."user_nutrition_profiles_weightgoal_enum" AS ENUM('lose', 'maintain', 'gain')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."user_nutrition_profiles_weightunit_enum" AS ENUM('kg', 'lbs')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."user_nutrition_profiles_heightunit_enum" AS ENUM('cm', 'ft')`,
    );
    await queryRunner.query(
      `CREATE TABLE "user_nutrition_profiles" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" uuid NOT NULL, "weight" numeric(5,2) NOT NULL, "height" numeric(5,2) NOT NULL, "age" integer NOT NULL, "gender" "public"."user_nutrition_profiles_gender_enum" NOT NULL, "activityLevel" "public"."user_nutrition_profiles_activitylevel_enum" NOT NULL, "weightGoal" "public"."user_nutrition_profiles_weightgoal_enum" NOT NULL, "targetWeight" numeric(5,2) NOT NULL, "weeklyWeightChange" numeric(3,2) NOT NULL, "dailyCalories" integer NOT NULL, "proteinGrams" numeric(6,2) NOT NULL, "carbsGrams" numeric(6,2) NOT NULL, "fatGrams" numeric(6,2) NOT NULL, "weightUnit" "public"."user_nutrition_profiles_weightunit_enum" NOT NULL DEFAULT 'kg', "heightUnit" "public"."user_nutrition_profiles_heightunit_enum" NOT NULL DEFAULT 'cm', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_57b099549e2e4cd3f33a72bd459" UNIQUE ("userId"), CONSTRAINT "REL_57b099549e2e4cd3f33a72bd45" UNIQUE ("userId"), CONSTRAINT "PK_ef7b6c66c5f685c2f67c4c5cba4" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `ALTER TABLE "routine_session_entity" ADD CONSTRAINT "FK_b479568f8a3cb5ee69fb7a5f943" FOREIGN KEY ("routineId") REFERENCES "routine_entity"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "routine_entity" ADD CONSTRAINT "FK_231af93c14eab9b726ae07fa6ab" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "food_entries" ADD CONSTRAINT "FK_20df2413919b31bced5d0eb5264" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "routine_exercise_entity" ADD CONSTRAINT "FK_9c256a7a0f32a394a27c90055e8" FOREIGN KEY ("exerciseId") REFERENCES "exercise_entity"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "routine_exercise_entity" ADD CONSTRAINT "FK_1cbefc5176ebcba1efc63dd1673" FOREIGN KEY ("routineId") REFERENCES "routine_entity"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "sets" ADD CONSTRAINT "FK_b1ebe417b8359c22baffd84cb79" FOREIGN KEY ("routineExerciseId") REFERENCES "routine_exercise_entity"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_nutrition_profiles" ADD CONSTRAINT "FK_57b099549e2e4cd3f33a72bd459" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "user_nutrition_profiles" DROP CONSTRAINT "FK_57b099549e2e4cd3f33a72bd459"`,
    );
    await queryRunner.query(
      `ALTER TABLE "sets" DROP CONSTRAINT "FK_b1ebe417b8359c22baffd84cb79"`,
    );
    await queryRunner.query(
      `ALTER TABLE "routine_exercise_entity" DROP CONSTRAINT "FK_1cbefc5176ebcba1efc63dd1673"`,
    );
    await queryRunner.query(
      `ALTER TABLE "routine_exercise_entity" DROP CONSTRAINT "FK_9c256a7a0f32a394a27c90055e8"`,
    );
    await queryRunner.query(
      `ALTER TABLE "food_entries" DROP CONSTRAINT "FK_20df2413919b31bced5d0eb5264"`,
    );
    await queryRunner.query(
      `ALTER TABLE "routine_entity" DROP CONSTRAINT "FK_231af93c14eab9b726ae07fa6ab"`,
    );
    await queryRunner.query(
      `ALTER TABLE "routine_session_entity" DROP CONSTRAINT "FK_b479568f8a3cb5ee69fb7a5f943"`,
    );
    await queryRunner.query(`DROP TABLE "user_nutrition_profiles"`);
    await queryRunner.query(
      `DROP TYPE "public"."user_nutrition_profiles_heightunit_enum"`,
    );
    await queryRunner.query(
      `DROP TYPE "public"."user_nutrition_profiles_weightunit_enum"`,
    );
    await queryRunner.query(
      `DROP TYPE "public"."user_nutrition_profiles_weightgoal_enum"`,
    );
    await queryRunner.query(
      `DROP TYPE "public"."user_nutrition_profiles_activitylevel_enum"`,
    );
    await queryRunner.query(
      `DROP TYPE "public"."user_nutrition_profiles_gender_enum"`,
    );
    await queryRunner.query(`DROP TABLE "sets"`);
    await queryRunner.query(`DROP TABLE "routine_exercise_entity"`);
    await queryRunner.query(
      `DROP TYPE "public"."routine_exercise_entity_repstype_enum"`,
    );
    await queryRunner.query(
      `DROP TYPE "public"."routine_exercise_entity_weightunit_enum"`,
    );
